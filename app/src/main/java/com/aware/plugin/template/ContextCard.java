...
public class ContextCard implements IContextCard {
    ...
    private static final String TAG = "ContextCard";
    ...
    private Runnable uiChanger = new Runnable() {
        ...
        public void run() {
            counter++;
            Log.d(TAG, "im here in run in contextCard.java");
    ...
    public View getContextCard(Context context) {
        sContext = context;
        Log.d(TAG, "im here in getContextCard in contextCard.java");
        ...
        Locations e = Locations.getService();
        ...
        logo_image = (ImageView) card.findViewById(R.id.facebookLogo);
